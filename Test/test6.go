...
func Test6() {
	...
	testFS.GC(-1)
	printSingleBlock(testFS, 386)
	printSingleBlock(testFS, 387)
	printSingleBlock(testFS, 389)
	printSingleBlock(testFS, 390)
	printSingleBlock(testFS, 391)
	printSingleBlock(testFS, 392)
	printSingleBlock(testFS, 393)
	printSingleBlock(testFS, 394)
	printSingleBlock(testFS, 395)
	fmt.Println("INODEMAP:", testFS.ReadSuperUnsafe().INodeMaps)
